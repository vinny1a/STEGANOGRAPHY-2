...
class ADMIN_LOGIN:
    ...
    def Cancel_login(self):
        msg = messagebox.askyesno('Login page','Are you sure, you want to cancel?')
        if (msg):
            exit()
    ...
    def login_admin(self):
        ...
        if (name == "shyam") and (password == "123"):
            self.jump_admin()
        else:
    ...
    def __init__(self):
        ...
        _bgcolor = 'black'  # X11 color: 'gray85'
        _fgcolor = 'grey'  # X11 color: 'black'
        _compcolor = 'black' # X11 color: 'gray85'
        _ana1color = 'black' # X11 color: 'gray85'
        _ana2color = 'black' # Closest X11 color: 'gray92'
